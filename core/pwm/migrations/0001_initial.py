# Generated by Django 4.2.16 on 2024-09-24 06:49
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, max_length=255, unique=True, verbose_name='نام اکانت')),
                ...
                ('updated_at', models.DateTimeField(auto_now=True, max_length=100, verbose_name='آخرین بروزرسانی')),
                ('server', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.DO_NOTHING, to='pwm.winserver', verbose_name='نام سرور')),
            ],
            options={
