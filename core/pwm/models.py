...
class WinServer(models.Model):
    ...
    name = models.CharField(blank=False,unique=True, max_length=255,verbose_name="نام سرور")
    ip = models.CharField(blank=False, max_length=25,verbose_name="آدرس سرور")
    port = models.CharField(blank=False, max_length=25,verbose_name="پورت ldap سرور")
    proxy_user = models.CharField(blank=False, max_length=25,verbose_name="نام کاربری")
    proxy_password = models.CharField(blank=False, max_length=25,verbose_name="کلمه عبور")
    ldap_domain = models.CharField(blank=True, max_length=25,verbose_name="دامنه")
    base_dn = models.CharField(blank=True, max_length=255,verbose_name="Base DN")
...
#     servers = models.ManyToManyField(WinServer)  # Many-to-many relationship with Server
#     accounts = models.ManyToManyField(WinUser)  # Many-to-many relationship with ServerAccount
